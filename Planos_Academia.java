...
public class Planos_Academia {
	...
	public static void main(String[] args) {
		...
		desconto = plano_intermediario  - plano_intermediario  * 0.0;
		System.out.println("Não há desconto " );
		}
		break;
		case "plano_avancado":
		...
		desconto = plano_avancado  - plano_avancado  * 0.0;
		System.out.println("Não há desconto "+ desconto );
		}
		break;
		case "plano_vip":
		if (data <= 3 ) {  
		...
		desconto = plano_vip - plano_vip  * 0.0;
		System.out.println("Não há desconto "+ desconto );
		}
		break;
